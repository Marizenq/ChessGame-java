...
package model.pieces; // Define o pacote onde a classe está localizada para fins de organização.
...
public class King extends Piece { //Rei
     ...
     */
    @Override
    public List<Position> getAttacks() { // retorna as 8 casas adjacentes/ ao lado, independentemente de estarem ocupadas.
        ...
        return attacks; // Finaliza o método e devolve a lista de casas que o Rei ataca.
    }
}
